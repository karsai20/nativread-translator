...
export const BOOK_TIERS = [
  ...
  // The ceiling. Readers pay at most 2990 Ft / €9.99 for a book; above 3M
  // characters the translation costs more than that leaves after VAT and
  // commission. The t7/t8 products stay in App Store Connect, withdrawn from
  // sale; a longer book would be sold in ≤3M parts if that ever matters.
